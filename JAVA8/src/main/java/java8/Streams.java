...
public class Streams {
	...
	public static void main(String[] args) {
		 ...
		 * Scanner(System.in); List<String> items = new ArrayList<String>(); for
		 * (int i = 0; i < 2; i++) { items.add(scanner.next()); }
		 * System.out.println("Unfiltered List :- " + items); String prefix =
		 * "JD";
		 * 
		 ...
		 * 7, 8, 9 }); stream1.forEach(p -> System.out.println(p));
		 */
		 ...
		 * 
		 * List<Long> longs = random.longs( 5 ).boxed().collect(
		 * Collectors.toList() ); System.out.println(longs);
		 */
	}
